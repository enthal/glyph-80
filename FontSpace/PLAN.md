...
- [x] Text preview — editable sample text painted with the page's glyphs (entry-gated) ([spec/12](spec/12-gui.md) §12.10, [spec/09](spec/09-rendering.md)). — PR pending *(colors/inversion/zoom/spacing/wrap/presets/multi-page are follow-ups)*
