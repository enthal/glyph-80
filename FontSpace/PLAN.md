...
- [x] Guides UI — add H/V, show/hide, edit position, remove (undoable, via new `remove_guide`/`set_guide_visible` ops) ([spec/12](spec/12-gui.md) §12.6). *(drag-on-matrix, rename/lock, copy-to-pages are follow-ups)*
