...
- The undo/redo stack (chapter 7) is workspace-level so a cross-document transaction unwinds both sides together; per-document `dirty` flags update from whichever documents a transaction touched.
